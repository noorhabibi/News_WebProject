	...
	<div class="col-md-12">
				...
				<table class="table posts-table table-striped table-hover">
					<thead>
						<tr>
							...
							<th>
								Action
								<a href="<?php echo base_url('index.php/post/add'); ?>" class="pull-right"><i class="fa fa-fw fa-plus"></i> Add new</a>
							</th>
						</tr>
					</thead>
					<tbody>
						<?php foreach($data['posts'] as $post): ?>
							<tr>
								...
								<td>
									<a href="<?php echo base_url('index.php/news/detail/' . $post->idpost); ?>">
										<i class="fa fa-fw fa-desktop"></i> Preview
									</a>
									&nbsp; | &nbsp;
									<a href="<?php echo base_url('index.php/post/delete/' . $post->idpost); ?>">
		...
		<?php else: ?>
			<p class="alert bg-info">
				<i class="fa fa-fw fa-exclamation"></i> No posts found. <a href="<?php echo base_url('index.php/post/add'); ?>">Add your first post</a> now.
			</p>
		<?php endif; ?>
	</div>
</div>