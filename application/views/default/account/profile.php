<div class="row">
	<div class="col-md-12">
		...
		<form method="post" action="<?php echo base_url('index.php/account'); ?>">
			<div class="form-group">
				<label for="signup_email">Email</label>
				<input type="email" name="email" id="signup_email" value="<?php echo $data['user']->email; ?>" class="form-control" />
			</div>
			<div class="form-group">
